...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_grease_js__ = __webpack_require__(5);


const container = document.querySelector('.grease');
const grease = new __WEBPACK_IMPORTED_MODULE_0__js_grease_js__["a" /* default */](container, {
	dots: true,
	ticker: true,
	infinite: true
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__touch_utility__ = __webpack_require__(6);
...
class Grease {
   ...
   */
	...
	setupBindings() {
		const touchEl = new __WEBPACK_IMPORTED_MODULE_1__touch_utility__["a" /* default */](this.track);

		// window.addEventListener('load', this.initializeSizes(this.el) );
		window.addEventListener('load', __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.debounce(function(){
				this.initializeSizes(this.el);
			},200).bind(this)
		);
		window.addEventListener('resize', __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.throttle(function(){
				this.initializeSizes(this.el);
			},50).bind(this)
		);
...
/* harmony default export */ __webpack_exports__["a"] = Grease;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = TouchUtil;
